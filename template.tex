...
$font-settings.latex()$
\usepackage{fontspec}
% Improve typography and ensure missing glyphs (e.g., U+2011) are covered via fallback
\defaultfontfeatures{Ligatures=TeX,Renderer=Harfbuzz}
\setmainfont{Space Grotesk}[FallbackFamilies={DejaVu Sans}]
\setsansfont{Space Grotesk}[FallbackFamilies={DejaVu Sans}]
\setmonofont{Space Grotesk}[FallbackFamilies={DejaVu Sans}]

% Fallback mapping for missing Unicode characters (e.g., non-breaking hyphen U+2011)
% Map U+2011 (non-breaking hyphen) to regular hyphen even if newunicodechar is unavailable
...
% Définir une police de fallback pour les symboles
...
% Définir les préfixes avec symboles
\newcommand{\prefixone}{{\symbolsfont██}\hspace{0.5em}}
\newcommand{\prefixtwo}{{\symbolsfont████}\hspace{0.5em}}
\newcommand{\prefixthree}{{\symbolsfont██████}\hspace{0.5em}}
\newcommand{\prefixfour}{{\symbolsfont████████}\hspace{0.5em}}
\newcommand{\prefixfive}{{\symbolsfont██████████}\hspace{0.5em}}
